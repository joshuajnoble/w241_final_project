...
simple_model1_rse <- lmtest::coeftest(simple_model1, vcov. = sandwich::vcovHC(simple_model1, type = 'HC1'))
simple_model2_rse <- lmtest::coeftest(simple_model2, vcov. = sandwich::vcovHC(simple_model2, type = 'HC1'))

stargazer(simple_model1_rse, simple_model2_rse,
          type="text",
          header = TRUE)
...
```{r}
edu_model1 <- lm(q1_right ~ q1_treat + as.factor(Edu_Level) + q1_treat*as.factor(Edu_Level), data = d_j)
edu_model2 <- lm(q2_right ~ q2_treat + as.factor(Edu_Level) + q2_treat*as.factor(Edu_Level), data = d_j)
edu_model1_rse <- lmtest::coeftest(edu_model1, vcov. = sandwich::vcovHC(edu_model1, type = 'HC1'))
edu_model2_rse <- lmtest::coeftest(edu_model2, vcov. = sandwich::vcovHC(edu_model2, type = 'HC1'))

stargazer(edu_model1_rse, edu_model2_rse,
          type = 'text',
          header = T)
...
```{r}
esl_model1 <- lm(q1_right ~ q1_treat + as.factor(ESL == "Yes") + q1_treat*as.factor(ESL=="Yes"), data = d_j)
esl_model2 <- lm(q2_right ~ q2_treat + as.factor(ESL == "Yes") + q2_treat*as.factor(ESL=="Yes"), data = d_j)
esl_model1_rse <- lmtest::coeftest(esl_model1, vcov. = sandwich::vcovHC(esl_model1, type = 'HC1'))
esl_model2_rse <- lmtest::coeftest(esl_model2, vcov. = sandwich::vcovHC(esl_model2, type = 'HC1'))

stargazer(esl_model1_rse, esl_model2_rse,
          type = 'text',
          header = T)
...
```{r}
age_model1 <- lm(q1_right ~ q1_treat + Birthyear + q1_treat*Birthyear, data = d_j)
age_model2 <- lm(q2_right ~ q2_treat + Birthyear + q2_treat*Birthyear, data = d_j)
age_model1_rse <- lmtest::coeftest(age_model1, vcov. = sandwich::vcovHC(age_model1, type = 'HC1'))
age_model2_rse <- lmtest::coeftest(age_model2, vcov. = sandwich::vcovHC(age_model2, type = 'HC1'))
  
stargazer(age_model1_rse, age_model2_rse,
          type = 'text',
          header = T)
```
