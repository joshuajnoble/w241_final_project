...
demo <- data.table("Educational Level"=a$Edu_Level, "Count"=a$N, "%Total"=round((a$N/sum(a$N))*100, 1), "Mean Age"=round(b$Birthyear, 1), "%ESL"=round((c$N/e$ESL)*100, 1))
png("demographics.png", height = 2,width = 7,units = "in", res = 72)
p<-tableGrob(demo)
grid.arrange(p)
dev.off()
```
...
# Print grid matrix of both study question confusion matrices:
